...
{
	if (_mem_md_main_data_1._md_1_data_bit._md_1_pwm_value != 0) _mem_md_main_data_1._md_1_data_bit._md_1_pwm_value += _mem_md_main_pwm_revis;
	
	if (_mem_md_main_nf_turn == TRUE)	_mem_md_main_data_0._md_0_data_bit._md_0_sig_mode = TURN_SIG_ROTATE(_mem_md_main_data_0._md_0_data_bit._md_0_sig_mode);
